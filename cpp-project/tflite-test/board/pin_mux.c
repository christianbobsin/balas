...
void InitUARTUsbc(void)
{
    ...
    PORT_SetPinMux(INITUARTUSBC_DEBUG_UART_RX_PORT, INITUARTUSBC_DEBUG_UART_RX_PIN, kPORT_MuxAlt2);
    ...
    PORT_SetPinMux(INITUARTUSBC_DEBUG_UART_TX_PORT, INITUARTUSBC_DEBUG_UART_TX_PIN, kPORT_MuxAlt2);
