...
/* Symbols to be used with PORT driver */
#define INITUARTUSBC_DEBUG_UART_RX_PORT PORT1               /*!<@brief PORT peripheral base pointer */
#define INITUARTUSBC_DEBUG_UART_RX_PIN 8U                   /*!<@brief PORT pin number */
#define INITUARTUSBC_DEBUG_UART_RX_PIN_MASK (1U << 8U)      /*!<@brief PORT pin mask */
                                                            /* @} */
...
/* Symbols to be used with PORT driver */
#define INITUARTUSBC_DEBUG_UART_TX_PORT PORT1               /*!<@brief PORT peripheral base pointer */
#define INITUARTUSBC_DEBUG_UART_TX_PIN 9U                   /*!<@brief PORT pin number */
#define INITUARTUSBC_DEBUG_UART_TX_PIN_MASK (1U << 9U)      /*!<@brief PORT pin mask */
                                                            /* @} */
